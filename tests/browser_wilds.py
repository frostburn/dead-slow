...
with sync_playwright() as pw:
    ...
    check('World 5 has exactly twelve courses and still no circuit',page.locator('.level-card').count()==12 and '0 / 12' in page.locator('.world-progress').inner_text() and 'all 48' in page.locator('#dialog').inner_text())
    shot('twelve-courses')
