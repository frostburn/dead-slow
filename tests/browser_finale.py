...
with sync_playwright() as pw:
    ...
    check('Course count and existing Grand Tour remain honest', '0 / 12 COURSES COMPLETE' in page.locator('#dialog').inner_text() and 'all 48' in page.locator('#dialog').inner_text())
    shot('world-five')
