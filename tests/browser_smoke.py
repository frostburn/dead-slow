...
with sync_playwright() as p:
    ...
    check('World selector displays three campaign tabs',page.locator('[data-world]').count()==3)
    ...
    check('Grand Tour uses the complete 36-stage route',page.evaluate('DeadSlowTest.state.marathon.route.length===36'))
    ...
    check('All 36 stage charts render without an exception',not errors)
