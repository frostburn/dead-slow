(function (root) {
    ...
    const worlds = [
        ...
        { id:'pale-reach', number:7, name:'Race for the Pale Reach', subtitle:'PASSAGE SERVICE · 6 OF 12 AVAILABLE', theme:'polar', partial:true, description:'Open passages, recover a survey crew, defend a supply base, and strike a military resupply station. The Free Anchorage Council, Narrows Compact and Shelf League disagree over a changing polar basin. The first six assignments are playable; the full campaign circuit is still to come.' },
