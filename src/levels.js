(function (root) {
    ...
    const worlds = [
        ...
        { id:'long-grade', number:5, name:'The Long Grade', subtitle:'HEAVY RAIL · EIGHT ASSIGNMENTS', theme:'rail', partial:true, description:'Freight handling from quarry yards to the export terminal. Meet traffic, catch runaways, cross wet grades and plan heavy or oversized loads.' },
