(function (root) {
    ...
    const worlds = [
        ...
        { id:'pale-reach', number:7, name:'Race for the Pale Reach', subtitle:'SURFACE & UNDERWATER WATCH · 9 OF 12 AVAILABLE', theme:'polar', partial:true, description:'Open passages, defend the Council’s supply routes, and take Petrel beneath the ice for identification, covert recovery and passage defense. The Free Anchorage Council, Narrows Compact and Shelf League disagree over a changing polar basin. Nine assignments are playable; the final three and campaign circuit are still to come.' },
