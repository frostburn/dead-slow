(function(root) {
    ...
    const levels=[
        ...
        level('long-grade-9','A Push from Behind',
            'Couple the waiting helper to the rear, then take the ore train over the saddle. Leave the helper secured in Summit Yard and deliver the freight to the valley exchange.',
            'U / J raises / lowers rear assistance. Share the climb between both engines. As the head goes downhill, ease front power first, then reduce assistance as the tail crests. Watch coupler tension and compression.',
            [2600,1200],{
                scenery:'valley',thermal:false,helper:{tractive:190000},couplerLimit:240000,compressionLimit:125000,
                nodes:{start:[80,700,20],foot:[680,700,20],crest:[1380,410,44],yard:[1910,490,42],end:[2470,930,28]},
                tracks:[{id:'approach',a:'start',b:'foot',limit:8},
                    {id:'climb',a:'foot',b:'crest',points:[[680,700,20],[900,580,28],[1140,470,37],[1380,410,44]],limit:8},
                    {id:'summit-yard',a:'crest',b:'yard',points:[[1380,410,44],[1520,400,42],[1710,450,42],[1910,490,42]],limit:6},
                    {id:'exchange',a:'yard',b:'end',points:[[1910,490,42],[2100,680,36],[2290,850,29],[2470,930,28]],limit:6}],switches:[],
                groups:[{cars:[loco('approach',360),...Array.from({length:8},(_,i)=>wagon('O'+(i+1),'approach',336.8-i*25.2,{length:24,mass:70000}))]},
                    {secured:true,cars:[{...loco('approach',137.2),id:'helper',helper:true,name:'No. 42'}]}],
        ...
        level('long-grade-12','The Long Grade',
            ...
            'Set both ends of the long passing loop before descending. Preserve cool brakes for the terminal. Ease front power as the head crests; taper rear assistance as the last wagons come over. Finish with every wagon inside and every junction clear.',
            [3800,2000],{
                scenery:'valley',weather:'snow',thermal:true,helper:{tractive:190000},couplerLimit:260000,compressionLimit:135000,
                nodes:{start:[80,220,40],foot:[620,220,40],crest:[1330,360,65],yard:[1940,500,63],a:[2210,1120,31],b:[2750,1240,28],end:[3640,1770,13]},
                ...
                switches:[{node:'a',label:'Lantern west',stem:'descent',branches:['viaduct-main','lantern-loop'],names:['Main viaduct','Long passing loop']},
                ...
                traffic:[{id:'coastal',name:'Coastal passenger',depart:1700,speed:6,timetable:'Departs 28:20 · Lantern due 30:40',route:[['coastal-road',-1],['viaduct-main',-1],['descent',-1]],head:125,length:110}],
